...
console.log(createMenuItem("BLT", 4, "Lunch 2"));
console.log(createMenuItem("Steak and Lobster", 29, "Dinner"));
...
const burger = {
  ...
  discount: function(person, price){
...
console.log(addReview(reviews, 'Billy', 2, 'feedback'));
